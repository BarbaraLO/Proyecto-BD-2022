...
CREATE TABLE IF NOT EXISTS `Comuna` (
  ...
  CONSTRAINT `FK_Comuna_Region` FOREIGN KEY (`idRegion`) REFERENCES `Region` (`idRegion`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;

-- Volcando datos para la tabla inf0021.Comuna: ~32 rows (aproximadamente)
...
-- Volcando datos para la tabla inf0021.Especialidad: ~9 rows (aproximadamente)
...
-- Volcando datos para la tabla inf0021.Paciente: ~19 rows (aproximadamente)
...
CREATE TABLE IF NOT EXISTS `Profesional` (
  ...
  CONSTRAINT `FK_Profesional_Especialidad` FOREIGN KEY (`idEspecialidad`) REFERENCES `Especialidad` (`idEspecialidad`),
  CONSTRAINT `FK_Profesional_Sucursal` FOREIGN KEY (`idSucursal`) REFERENCES `Sucursal` (`idSucursal`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;

-- Volcando datos para la tabla inf0021.Profesional: ~16 rows (aproximadamente)
...
CREATE TABLE IF NOT EXISTS `Region` (
  `idRegion` int(2) unsigned zerofill NOT NULL,
  `nombreReg` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  PRIMARY KEY (`idRegion`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;

-- Volcando datos para la tabla inf0021.Region: ~16 rows (aproximadamente)
...
CREATE TABLE IF NOT EXISTS `Reserva` (
  ...
  CONSTRAINT `FK_Reserva_Paciente` FOREIGN KEY (`idPaciente`) REFERENCES `Paciente` (`idPaciente`),
  CONSTRAINT `FK_Reserva_Profesional` FOREIGN KEY (`idProfesional`) REFERENCES `Profesional` (`idProfesional`),
  CONSTRAINT `FK_Reserva_TipoCita` FOREIGN KEY (`idTipoCita`) REFERENCES `TipoCita` (`idTipoCita`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;

-- Volcando datos para la tabla inf0021.Reserva: ~3 rows (aproximadamente)
...
-- Volcando datos para la tabla inf0021.Sucursal: ~18 rows (aproximadamente)
...
-- Volcando datos para la tabla inf0021.TipoCita: ~9 rows (aproximadamente)
